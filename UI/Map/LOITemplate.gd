...
@onready var loi_shape_polygon = $LOIShapePolygon
@onready var loi_shape_line = $LOIShapeLine
@onready var loi_shape_fill = $LOIShapeFill
@onready var loi_sprite = $LOISprite
...
func _input(event):
	if is_hovered and MapGlobal.is_viewing_species == false:
